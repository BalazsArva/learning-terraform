...
namespace LearningTerraform.ApiClient
{
    ...
    public partial class OwnersClient 
    {
        ...
        public OwnersClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<OwnerResponse>(response_, headers_).ConfigureAwait(false);
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<OwnerResponse> GetByIdAsync(string id)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<OwnerResponse> GetByIdAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Owners/{id}");
    ...
    public partial class PetsClient 
    {
        ...
        public PetsClient(string baseUrl, System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = baseUrl; 
            _httpClient = httpClient; 
            _settings = new System.Lazy<Newtonsoft.Json.JsonSerializerSettings>(CreateSerializerSettings);
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> CreateAsync(string ownerId, CreatePetRequest request)
        {
            return CreateAsync(ownerId, request, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> CreateAsync(string ownerId, CreatePetRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (ownerId == null)
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/owners/{ownerId}/pets");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 201)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<PetResponse>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new SwaggerException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
        ...
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<PetResponse> GetByIdAsync(string id)
        {
            return GetByIdAsync(id, System.Threading.CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<PetResponse> GetByIdAsync(string id, System.Threading.CancellationToken cancellationToken)
        {
            if (id == null)
                throw new System.ArgumentNullException("id");
    ...
    public partial class OwnerResponse : System.ComponentModel.INotifyPropertyChanged
    {
        private string _id;
        private string _firstName;
        private string _lastName;
        private System.Collections.Generic.List<PetResponse> _pets;
        ...
        public System.Collections.Generic.List<PetResponse> Pets
        {
            get { return _pets; }
            set 
            {
        ...
        public static OwnerResponse FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<OwnerResponse>(data);
        }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.1.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class PetResponse : System.ComponentModel.INotifyPropertyChanged
    {
        private string _id;
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.3.1.0 (Newtonsoft.Json v12.0.0.0)")]
    public partial class CreatePetRequest : System.ComponentModel.INotifyPropertyChanged
    {
        private string _name;
        ...
        public static CreatePetRequest FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<CreatePetRequest>(data);
        }
